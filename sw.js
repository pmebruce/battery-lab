const CACHE = 'battery-lab-github-v6';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './manifest.webmanifest', './icons/icon-192.png?v=6', './icons/icon-512.png?v=6', './apple-touch-icon.png?v=6'];
