const CACHE = 'battery-lab-github-v7';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './manifest.webmanifest', './icons/icon-192.png?v=7', './icons/icon-512.png?v=7', './apple-touch-icon.png?v=7'];
