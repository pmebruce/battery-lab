const CACHE = 'battery-lab-github-v8';
const ASSETS = ['./', './index.html', './styles.css?v=8', './app.js', './manifest.webmanifest', './icons/icon-192.png?v=7', './icons/icon-512.png?v=7', './apple-touch-icon.png?v=7'];
