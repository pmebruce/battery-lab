const CACHE = 'battery-lab-github-v2';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './manifest.webmanifest', './icons/icon-192.png?v=2', './icons/icon-512.png?v=2', './apple-touch-icon.png?v=2'];
