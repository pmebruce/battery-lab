const CACHE = 'battery-lab-github-v5';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './manifest.webmanifest', './icons/icon-192.png?v=5', './icons/icon-512.png?v=5', './apple-touch-icon.png?v=5'];
